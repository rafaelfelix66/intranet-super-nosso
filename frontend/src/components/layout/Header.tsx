  ...
  return (
    <header className="w-full bg-white dark:bg-gray-900 border-b px-4 py-3 sticky top-0 z-30 shadow-sm transition-all">
      <div className="flex justify-between items-center">
        <div className="ml-4 sm:ml-16 md:ml-20 lg:ml-64 transition-all">
          <h2 className="text-xl font-bold text-supernosso-darkgray">Bem-vindo, {user?.name?.split(' ')[0] || 'Usuário'}</h2>
        </div>
